...
export default function ChairSection(){
 ...
 return <section className="webSection" id="network"><div className="webWrap webChairGrid">
    <div className="webVideo"><YouTubeInline url={c.videoUrl} thumbnail={c.videoThumbnailUrl} title={`${c.name} 의장 인사 영상`} className="chairInlineVideo"/><div className="webVideoText"><small>의장 인사 영상</small></div></div>
