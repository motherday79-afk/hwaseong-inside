...
export default function SiteFooter({className=''}){
  ...
  return <footer className={`v7Footer ${className}`.trim()}><div className="v7Shell v7FooterGrid">
    <div><a className="v7FooterBrand" href="/"><BrandIcon name="brandSpark" size={19}/> 화성인사이드</a><p>사람과 사람을 잇고 가치 있는 네트워크를 만듭니다.</p><div className="v7Social"><span aria-label="Instagram"><BrandIcon name="instagram" size={15}/></span><span aria-label="LinkedIn"><BrandIcon name="linkedin" size={15}/></span><span aria-label="YouTube"><BrandIcon name="youtube" size={16}/></span></div><small>© 2026 화성인사이드</small></div>
  ...
  </div><a className="v7TopBtn" href="#top" aria-label="맨 위로"><BrandIcon name="arrowUp" size={18}/></a></footer>;
}
