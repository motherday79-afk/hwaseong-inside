...
export default function Home(){
  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="mainCard wrap" id="network">
        <div className="chairGrid">
          <div className="movie">
            ...
            <b>의장 인사 영상</b>
            <div className="movieBottom"><i></i><div><span>▶</span><span>⌕</span><small>0:10 / 1:48</small><em>▣　⚙　□　⛶</em></div></div>
          </div>
          <div className="messageBox">
            <h3>의장 인사말</h3>
            <div className="messageBody"><img src="/assets/ui/chair-portrait.png" alt="의장"/><div><p>안녕하세요.<br/>화성인사이드 의장 김도현입니다.</p><p>사람과 사람을 잇는 네트워크 안에 무너지지 않는 가치가 있습니다.</p><p>화성의 우리의 가치와 기회이고,<br/>함께 만들어갈 미래입니다.</p><p>화성인사이드는 여러분과 함께 그 여정을 이어갈 것입니다.</p></div></div>
      ...
      <section className="membersZone" id="community"><div className="wrap membersInner">
