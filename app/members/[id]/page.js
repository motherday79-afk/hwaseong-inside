...
export default async function MemberDetail({params}){
 ...
 return <main className="memberDetailDom v64">
  ...
  <section className="memberStoryGrid">
   ...
   <article className="memberPhilosophy memberCommonVisual">{detailAssets.philosophyImageUrl?<img src={detailAssets.philosophyImageUrl} alt="화성인사이드의 철학"/>:<div className="memberCommonFallback philosophyFallback"><b>★ 화성인사이드</b><h2>화성인사이드의 철학</h2><p>좋은 연결은 더 좋은 세상을 만듭니다.</p><p>문화와 기술, 사람과 사람이 만나는 가치를 추구합니다.</p><p>실력 기반의 네트워크로 새로운 기회를 만듭니다.</p></div>}</article>
  </section>
