...
export async function GET(){
 ...
 const [{data:accounts,error},{data:members}]=await Promise.all([
  ...
  admin.from('members').select('id,user_id,name,job,age,gender,public_email,phone,school,area,tier,tags,intro,profile_image_url,is_published,youtube_url,youtube_thumbnail_url')
 ]);
...
export async function PUT(request){
 ...
 try{
  ...
  const map={name:'name',job:'job',age:'age',gender:'gender',public_email:'public_email',phone:'phone',school:'school',area:'area',tier:'tier',tags:'tags',intro:'intro',profile_image_url:'profile_image_url',is_published:'is_published',youtube_url:'youtube_url',youtube_thumbnail_url:'youtube_thumbnail_url'};
